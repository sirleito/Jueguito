document.addEventListener('DOMContentLoaded',function(){
	...
	var personajes = [
		new heroes("Gladiador", 50, 1000, "img/hombre.png", "Puñote", 7),
		new heroes("Guerrero", 100, 500, "img/gato.png", "Ejecucion", 6),
		new heroes("Asesina", 75, 750, "img/mujer.png", "Degradación", 4),
	];
	

	var malos = [
		new heroes("Zombie", 10, 500, "img/zombie.png", "Poder", 5),
		new heroes("Alien", 20, 600, "img/alien.png", "Poder", 5),
		new heroes("Bruja", 30, 1000, "img/bruja.png", "Poder", 4),
	];
